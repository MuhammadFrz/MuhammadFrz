<div align="center">
  ...
  <p align="center">
    <strong>Creative Frontend & Web Developer</strong> passionate about building high-performance, interactive, and visually stunning web experiences.
  </p>
...
- 🚀 **Specialty:** Frontend architecture & creative web engineering with a focus on modern frameworks and 3D web graphics.
- 🎨 **Creative Tech:** Crafting fluid web interactions with **Three.js**, **GSAP**, and **Lenis** for silky-smooth motion and 3D product configurators.
- 🛠️ **Architecture:** Engineering scalable, clean, and robust applications using **Nuxt**, **Vue 3**, and **TypeScript**.
- 💡 **Philosophy:** Seamless user experience, pixel-perfection, and high-performance 60fps rendering.
...
<p>
  ...
  <img src="https://img.shields.io/badge/Ubuntu_Linux-E95420?style=for-the-badge&logo=ubuntu&logoColor=white" alt="Ubuntu" />
